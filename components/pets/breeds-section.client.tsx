    ...
    <div className="flex flex-col gap-8 md:gap-10">
      <div className="flex flex-col lg:flex-row justify-between lg:items-start gap-6 lg:gap-10">
        <div className="lg:max-w-[500px] xl:max-w-[530px]">
          <h2 className="font-geologica font-semibold text-4xl sm:text-5xl leading-tight md:text-6xl md:leading-tight lg:text-[80px] lg:leading-[1em] text-black">
            {t("title")}
          </h2>
        </div>
            ...
            {displayedBreeds.map((breed) => {
              ...
              return (
                <Link
                  ...
                  className="group relative bg-stone-100 rounded-[20px] p-4 pt-5 flex flex-col items-center w-[200px] sm:w-[215px] h-[280px] sm:h-[297px] flex-shrink-0 snap-start cursor-pointer transition-shadow duration-300 ease-in-out hover:shadow-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-lime-500 focus-visible:ring-offset-2"
                ...
                >
                  ...
                  <div className="w-full h-[40px] flex items-center justify-center px-1">
                    <span
                      className="font-geologica font-bold text-[15px] sm:text-base leading-snug text-center text-black/90 overflow-hidden block"
                      style={{
                        display: "-webkit-box",
                        WebkitLineClamp: 2,
