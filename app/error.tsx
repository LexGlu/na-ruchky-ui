...
export default function Error({
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-[20px] py-20 m-1 bg-white">
      ...
      <button
        onClick={handleReset}
        className="mt-4 bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-3xl cursor-pointer"
      >
        Спробувати знову
      </button>
    </div>
