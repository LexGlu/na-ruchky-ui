...
// Component for the hero section with search functionality
const HeroSection = () => {
  return (
    <div className="bg-[#CCF28C] rounded-[17px] pt-8 pb-12 px-4 relative">
      ...
      <div className="container mx-auto">
        ...
        <h2 className="text-center mb-8 text-2xl font-light">
          Знайдіть свого працівника щастя
        </h2>
...
// Component for the decorative paw prints
...
// Component for the dog illustrations
  ...
  return (
    <div className="hidden md:block absolute -bottom-5 right-4">
      <div className="flex items-end">
        ...
        <div className="h-27 w-27 relative ml-2 bottom-1">
          <Image
            src={dog2}
            alt="Dog"
            fill
